...
copy root /usr/aarch64-unknown-linux-gnu/
...
build aarch64-unknown-linux-gnu-emerge -v1 \
  sys-devel/binutils sys-libs/binutils-libs sys-libs/glibc sys-kernel/linux-headers \
...
build aarch64-unknown-linux-gnu-emerge -v1 sys-devel/gcc

commit "$DOCKER_USERNAME/aarch64-unknown-linux-gnu-gentoo-stable-amd64-crossdev:latest"
